...
A coluna Revisão só é marcada quando houver revisão humana da página — uma passada de revisão do Claude (gramática, concordância, bugs de LaTeX etc.) não conta como Revisão para este fim, mesmo que corrija erros reais.

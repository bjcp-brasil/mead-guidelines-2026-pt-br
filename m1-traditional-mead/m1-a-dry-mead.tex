...
\textbf{Sensação na Boca}: Corpo geralmente de baixo a médio, mas não deve parecer aguado. Hidroméis com maior força alcoólica podem apresentar corpo mais alto e maior aquecimento alcoólico. Sensação de corpo não deve ser acompanhada de dulçor residual perceptível. A carbonatação segue o nível declarado, podendo ir de tranquilo a espumante.

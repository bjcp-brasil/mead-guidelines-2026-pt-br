...
\textbf{Instruções para Inscrição}: Participantes devem especificar os níveis de dulçor, carbonatação e força alcoólica. Variedades de mel podem ser declaradas. A fruta deve obrigatoriamente ser declarada. Se variedades de fruta forem especificadas, espera-se que o caráter varietal correspondente esteja presente.

...
O dulçor residual e o final de boca devem corresponder ao nível de dulçor declarado. A acidez deve ser equilibrada, suave ou vibrante, mas não agressiva. O caráter de uva e de fermentação típico de vinhos também é aceitável em Pyment. Taninos podem fazer um hidromel suave parecer seco. Áspero, desagradável, excessivamente sulfuroso ou com características de levedura/autólise não são desejadas.
...
\textbf{Instruções para Inscrição}: Os participantes devem especificar os níveis de dulçor, carbonatação e teor alcoólico. Variedades de mel podem ser declaradas. A fruta utilizada deve ser declarada. Se variedades de uva forem especificadas, espera-se que o caráter varietal correspondente esteja presente.

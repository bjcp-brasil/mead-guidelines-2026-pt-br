...
\textbf{Instruções para Inscrição}: Participantes devem especificar os níveis de dulçor, carbonatação e força alcoólica. Variedades de mel podem ser declaradas. Os participantes devem especificar as frutas e os SHVs adicionados. Hidroméis com sabores picantes de pimenta devem ter especificado o nível de picância (suave, médio, forte) para auxiliar os jurados na ordenação das amostras.

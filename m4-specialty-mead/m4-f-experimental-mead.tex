...
\textbf{Instruções para Inscrição}: Os participantes devem especificar os níveis de dulçor, carbonatação e força alcoólica. O participante deve descrever a natureza experimental do hidromel com detalhes suficientes para justificar sua inscrição neste estilo.
